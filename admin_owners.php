...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<a href='admin_delete_user_owner.php?email=" . urlencode($row['email']) . "' style='color: #ff0000; text-decoration: none;' onclick='return confirm(\"Are you sure you want to delete this user?\")'>DELETE</a>";
        echo "</td>";
