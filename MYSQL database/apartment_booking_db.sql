...
CREATE TABLE `apartments` (
  ...
  `Private_bathroom` varchar(5) NOT NULL,
  `Toilet` varchar(5) NOT NULL,
  `Room_Amenities_Bed` varchar(5) NOT NULL,
  `Room_Amenities_Mattress` varchar(5) NOT NULL,
  `Room_Amenities_Table` varchar(5) NOT NULL,
  `Room_Amenities_Chair` varchar(5) NOT NULL,
  `Living_area_Dining_area` varchar(5) NOT NULL,
  `Living_area_Sitting_area` varchar(5) NOT NULL,
